<template>
    <template v-if="event.type === 'player_killed'">
        ...
        <div class="value">
            <span class="p-text-primary">{{event.body.player.firstName + ' ' + event.body.player.lastName}}&nbsp;</span>
    ...
    <template v-if="event.type === 'other'">
        <div class="key">{{time}}</div>
        <div class="value">
            <span v-if="event.body.player" class="p-text-primary">{{event.body.player.firstName + ' ' + event.body.player.lastName}}&nbsp;</span>
